document.addEventListener('DOMContentLoaded', () => {
    ...
    // ---- 3. AUDIO PLAYER MATRIX (COMPLETELY LOCAL COMPATIBLE) ----
    ...
    function toggleAudioTrack(e) {
        ...
        // Flush running engines
        killActiveAudioEngine();

        // Standard HTML5 Core Playback (Immune to Local Hard Drive CORS Security blocks)
        ...
        // Capture user scrubbing updates and update slider knob rotation
        ...
        // Volume slider adjustments link directly to shuriken rotation
    ...
    // Rotates the individual shuriken thumb based on value mapping
    ...
    function runTimelineSync(slider, display) {
        ...
        timelineInterval = setInterval(() => {
            if (currentAudio && !currentAudio.paused) {
                ...
                rotateShurikenKnob(slider); // Smoothly rotate timeline shuriken as track updates naturally
            }
        }, 100);
    }
