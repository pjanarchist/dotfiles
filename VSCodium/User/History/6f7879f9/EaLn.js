document.addEventListener('DOMContentLoaded', () => {
    ...
    // ---- 4. LOCAL AUDIO ENGINE & MECHANICAL ROTATION ENGINE ----
    ...
    // Initialize baseline mechanical angles on frame boot
    ...
    // Direct proportional mechanical tracking calculator
    function calculateMechanicalRotation(inputElement) {
        ...
        // Map progression natively to 720 degrees of rotation
        const calculatedDegrees = Math.floor(totalPercentage * 720);
        
        // Inline injection forces browser layout engine to update the asset frame immediately
        inputElement.style.transform = `rotate(${calculatedDegrees}deg)`;
    }
