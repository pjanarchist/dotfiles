document.addEventListener('DOMContentLoaded', () => {
    ...
    // Normalized Rotation Core: Computes positions precisely regardless of slider max differences
    function rotateShurikenKnob(inputElement) {
        ...
        const calculatedDegrees = totalPercentage * 720; // 2 complete spins across full slide tracks
    ...
    function killActiveAudioEngine() {
        ...
        document.querySelectorAll('.timeline-slider').forEach(s => {
            s.value = 0;
            s.style.setProperty('--shuriken-rotation', '0deg');
        });
